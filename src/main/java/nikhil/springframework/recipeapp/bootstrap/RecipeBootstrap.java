package nikhil.springframework.recipeapp.bootstrap;

import lombok.extern.slf4j.Slf4j;
import nikhil.springframework.recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        //Get all unit of measures for both the recipes
        ...
        //Bidirectional relationship between notes and recipe
